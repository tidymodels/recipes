...
exp_comp <-
  structure(c(0.129863464905676, 0.0759034631963958, 0.345979256585598,
              ...
              -0.429295233592478), .Dim = c(6L, 2L),
            .Dimnames = list(NULL, c("IC1", "IC2")))

exp_load <-
  structure(c(-0.41723456724402, 0.364056809629112, 0.406544129493068,
