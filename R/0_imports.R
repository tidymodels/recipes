...
#' @importFrom purrr map map_dbl map_lgl map_chr reduce
#' @importFrom purrr map_dfr map_if
#' @importFrom ipred ipredbagg
#' @importFrom tibble as_tibble add_column is_tibble tibble
#' @importFrom dplyr filter group_by count ungroup do mutate
#' @importFrom dplyr bind_rows slice rename select full_join
...
#' @importFrom rlang is_empty is_quosure as_character na_dbl syms !!
