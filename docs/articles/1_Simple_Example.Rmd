 ...
 * functions that subset on the role of the variables that have been specified so far: `is_outcome`, `is_predictor`, `has_role`, or 
 * similar functions for the type of data: `is_nominal`, `is_numeric`, and `type_is`. 
