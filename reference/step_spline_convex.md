...
- degree:
  ...
  The degree of C-spline defined to be the degree of the associated
  M-spline instead of actual polynomial degree. For example, C-spline
  basis of degree 2 is defined as the scaled double integral of
...
- options:
  ...
  [`splines2::cSpline()`](https://wwenjie.org/splines2/reference/cSpline.html)
...
#>   terms     id                 
#>   <chr>     <chr>              
#> 1 Longitude spline_convex_TpMy9
