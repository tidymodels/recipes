...
[`remove_role()`](https://recipes.tidymodels.org/reference/roles.md). A
`recipe` object can be created in several ways. If an analysis only
...
[`update_role()`](https://recipes.tidymodels.org/reference/roles.md),
[`add_role()`](https://recipes.tidymodels.org/reference/roles.md), and
[`remove_role()`](https://recipes.tidymodels.org/reference/roles.md) are
applied before steps and checks, regardless of where they are in the
pipeline.
...
use the
[`tidy()`](https://recipes.tidymodels.org/reference/tidy.recipe.md)
...
[`prep()`](https://recipes.tidymodels.org/reference/prep.md)). The
...
[`prep()`](https://recipes.tidymodels.org/reference/prep.md) function
can be used to estimate quantities required for the operations using a
data set (a.k.a. the training data).
[`prep()`](https://recipes.tidymodels.org/reference/prep.md) returns a
recipe.
...
[`bake()`](https://recipes.tidymodels.org/reference/bake.md) function is
used in the same manner that
[`predict()`](https://parsnip.tidymodels.org/reference/predict.model_fit.html)
...
[`prep.recipe()`](https://recipes.tidymodels.org/reference/prep.md) and
[`bake.recipe()`](https://recipes.tidymodels.org/reference/bake.md).
...
provided via
[`prep()`](https://recipes.tidymodels.org/reference/prep.md). Code that
only provides it via
[`prep()`](https://recipes.tidymodels.org/reference/prep.md) will
