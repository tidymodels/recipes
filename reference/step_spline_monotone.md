...
- degree:
  ...
  The degree of I-spline defined to be the degree of the associated
  M-spline instead of actual polynomial degree. For example, I-spline
  basis of degree 2 is defined as the integral of associated M-spline
  basis of degree 2.
...
- options:
  ...
  which should not include `x`, `df`, `degree`, `periodic`, or
  `intercept`.
...
monotonic. This means that, when used with a fitting function that
produces non-negative regression coefficients, the resulting fit is
monotonic.
