...
any of the checked columns does contain `NA` values. If the check
passes, nothing is changed to the data.

## tidy() results

When you
[`tidy()`](https://recipes.tidymodels.org/reference/tidy.recipe.md) this
check, a tibble with column `terms` (the selectors or variables
