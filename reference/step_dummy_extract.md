...
#>    terms  columns id                 
#>    <chr>  <chr>   <chr>              
#>  1 artist Thomas  dummy_extract_2Slih
#>  2 artist Schütte dummy_extract_2Slih
#>  3 artist John    dummy_extract_2Slih
#>  4 artist Akram   dummy_extract_2Slih
#>  5 artist Zaatari dummy_extract_2Slih
#>  6 artist Joseph  dummy_extract_2Slih
#>  7 artist Beuys   dummy_extract_2Slih
#>  8 artist Richard dummy_extract_2Slih
#>  9 artist Ferrari dummy_extract_2Slih
#> 10 artist León    dummy_extract_2Slih
#> # ℹ 2,663 more rows
tidy(dummies_specific, number = 1)
#> # A tibble: 1,216 × 3
#>    terms  columns              id                 
#>    <chr>  <chr>                <chr>              
#>  1 medium paper                dummy_extract_kJsyR
#>  2 medium Etching              dummy_extract_kJsyR
#>  3 medium Photograph           dummy_extract_kJsyR
#>  4 medium colour               dummy_extract_kJsyR
#>  5 medium gelatin silver print dummy_extract_kJsyR
#>  6 medium Screenprint          dummy_extract_kJsyR
#>  7 medium Lithograph           dummy_extract_kJsyR
#>  8 medium on paper             dummy_extract_kJsyR
#>  9 medium canvas               dummy_extract_kJsyR
#> 10 medium aquatint             dummy_extract_kJsyR
#> # ℹ 1,206 more rows
