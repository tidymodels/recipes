...
[`prep()`](https://recipes.tidymodels.org/reference/prep.md) that can be
used to do this. See the vignette on "Recipes and rsample" for an
example.
...
[`prep()`](https://recipes.tidymodels.org/reference/prep.md) argument
`fresh` to `TRUE`.
