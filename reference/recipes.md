...
[`recipe()`](https://recipes.tidymodels.org/reference/recipe.md) defines
the operations on the data and the associated roles. Once the
preprocessing steps are defined, any parameters are estimated using
[`prep()`](https://recipes.tidymodels.org/reference/prep.md). Once the
data are ready for transformation, the
[`bake()`](https://recipes.tidymodels.org/reference/bake.md) function
