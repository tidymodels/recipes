...
[`bake()`](https://recipes.tidymodels.org/reference/bake.md) function if
any of the checked columns does contain values it did not contain when
[`prep()`](https://recipes.tidymodels.org/reference/prep.md) was called
