...
#>   terms                    id             
#>   <chr>                    <chr>          
#> 1 all_numeric_predictors() kpca_poly_7oa3A
tidy(kpca_estimates, number = 3)
#> # A tibble: 5 × 2
#>   terms    id             
#>   <chr>    <chr>          
#> 1 carbon   kpca_poly_7oa3A
#> 2 hydrogen kpca_poly_7oa3A
#> 3 oxygen   kpca_poly_7oa3A
#> 4 nitrogen kpca_poly_7oa3A
#> 5 sulfur   kpca_poly_7oa3A
```
