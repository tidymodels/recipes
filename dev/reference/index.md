...
- [`recipes-package`](https://recipes.tidymodels.org/dev/reference/recipes.md)
...
- [`formula(`*`<recipe>`*`)`](https://recipes.tidymodels.org/dev/reference/formula.recipe.md)
  : Create a formula from a prepared recipe
- [`print(`*`<recipe>`*`)`](https://recipes.tidymodels.org/dev/reference/print.recipe.md)
  : Print a Recipe
- [`summary(`*`<recipe>`*`)`](https://recipes.tidymodels.org/dev/reference/summary.recipe.md)
  : Summarize a recipe
...
- [`selections`](https://recipes.tidymodels.org/dev/reference/selections.md)
  [`selection`](https://recipes.tidymodels.org/dev/reference/selections.md)
...
- [`has_role()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  ...
  [`all_datetime_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_double()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_double_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_factor()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_factor_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_integer()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_integer_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_logical()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_logical_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  ...
  [`all_ordered_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_string()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_string_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_unordered()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`all_unordered_predictors()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  [`current_info()`](https://recipes.tidymodels.org/dev/reference/has_role.md)
  : Role Selection
...
- [`discretize()`](https://recipes.tidymodels.org/dev/reference/discretize.md)
  [`predict(`*`<discretize>`*`)`](https://recipes.tidymodels.org/dev/reference/discretize.md)
  : Discretize Numeric Variables
...
- [`names0()`](https://recipes.tidymodels.org/dev/reference/names0.md)
  ...
  : Naming Tools
- [`prepper()`](https://recipes.tidymodels.org/dev/reference/prepper.md)
...
- [`update(`*`<step>`*`)`](https://recipes.tidymodels.org/dev/reference/update.step.md)
  : Update a recipe step

## Tidy Methods

- [`tidy(`*`<step_BoxCox>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_YeoJohnson>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_arrange>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_bin2factor>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_bs>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_center>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<check_class>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_classdist>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_classdist_shrunken>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<check_cols>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_corr>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_count>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_cut>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_date>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_depth>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_discretize>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_dummy>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_dummy_extract>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_dummy_multi_choice>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_factor2string>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_filter>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_filter_missing>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_geodist>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_harmonic>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_holiday>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_hyperbolic>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_ica>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_bag>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_knn>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_linear>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_lower>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_mean>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_median>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_mode>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_impute_roll>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_indicate_na>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_integer>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_interact>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_intercept>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_inverse>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_invlogit>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_isomap>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_kpca>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_kpca_poly>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_kpca_rbf>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_lag>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_lincomb>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_log>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_logit>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<check_missing>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_mutate>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_mutate_at>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_naomit>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<check_new_values>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_nnmf>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_nnmf_sparse>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_normalize>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_novel>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_ns>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_num2factor>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_nzv>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_ordinalscore>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_other>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_pca>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_percentile>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_pls>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_poly>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_poly_bernstein>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_profile>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_range>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<check_range>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_ratio>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_regex>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_relevel>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_relu>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_rename>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_rename_at>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_rm>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_sample>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_scale>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_select>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_shuffle>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_slice>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_spatialsign>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_spline_b>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_spline_convex>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_spline_monotone>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_spline_natural>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_spline_nonnegative>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_sqrt>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_string2factor>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<recipe>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<check>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_time>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_unknown>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_unorder>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_window>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
  [`tidy(`*`<step_zv>`*`)`](https://recipes.tidymodels.org/dev/reference/tidy.recipe.md)
