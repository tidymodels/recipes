...
The cell segmentation data will be used. It has 58 columns with predictors and a factor variable (which is the outcome). Each of the predictors has a suffix for the optical channel ("`Ch1`"-"`Ch4`""). We will first separate the data into a training and test set then remove unimportant variables:
 ...
 * functions that subset on the role of the variables that have been specified so far: `is_outcome`, `is_predictor`, `role_is`, `role_is_not`, or 
 * similar functions for the type of data: `is_nominal`, `is_numeric`, `type_is`, `type_is_not`. 
