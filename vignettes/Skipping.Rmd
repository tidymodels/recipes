...
description: |
  Steps generally will be applied to both the training and testing data set.
  There are times when it is advantageous to only apply to the training data
  set. This vignette will go over which steps default to skipping.
vignette: >
