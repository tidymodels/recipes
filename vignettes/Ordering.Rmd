...
* Always call `step_intercept` last, as the column it adds has predictor role and may be unintentionally modified by operators like `step_center` or `step_scale`.
