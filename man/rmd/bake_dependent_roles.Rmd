...
Recipes can label and retain column(s) of your data set that should not be treated as outcomes or predictors. For example, a unique identifier column or some other ancillary data that can be used to troubleshoot issues during model development.

As an example, you might have a date column that is transformed into features using [step_date()] or [step_holiday()]. 
