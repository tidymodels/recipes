...
[`update_role()`](https://recipes.tidymodels.org/reference/roles.md) can
...
[`has_role()`](https://recipes.tidymodels.org/reference/has_role.md) in
combination with other selection methods (see
